...
% TOC.
\newcommand{\mminitoc}{{\hypersetup{linkcolor=sbase02} \minitoc\vspace{.5cm}}}
...
\newcommand{\mylettrine}[3][]{%
    \lettrine[lines=3, lhang=.5, loversize=.1, #1]{\textcolor{sbase01}{#2}}{#3}%
}
...
\def\anone{\code{\bslash{}no\-ne}\xspace}
...
\DeclareMathOperator{\mcard}{card}
\DeclareMathOperator{\mrand}{rand}
\DeclareMathOperator{\mmin}{min}
\DeclareMathOperator{\mmax}{max}
\DeclareMathOperator{\mpop}{pop}
\DeclareMathOperator{\mlog}{log}
\DeclareMathOperator{\msin}{sin}
\DeclareMathOperator{\mcos}{cos}
...
\newcommand{\ingreek}[1]{\foreignlanguage{greek}{\em \ingreek{#1}}}
