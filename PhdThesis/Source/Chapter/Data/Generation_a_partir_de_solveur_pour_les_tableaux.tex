...
expliquerons pourquoi nous avons choisi de développer notre propre solveur.
...
\code{a[$K$]!: \_} signifie que toute valeur de $K$ est la clé d'une paire dans
le tableau \code{a}, et que toute paire dont la clé est dans $K$ n'a pas sa
valeur dans \code{\_} (tout). Autrement dit~: aucune paire du tableau \code{a}
