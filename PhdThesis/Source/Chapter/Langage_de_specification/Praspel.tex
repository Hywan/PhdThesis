...
normale. La figure~\ref{figure:language:typical_contract} montre la localisation
typique des clauses sur une classe \code{C} avec un attribut \code{a} et une
méthode \code{f}. La clause \ainvariant est localisée avant l'attribut \code{a}.
Les autres clauses sont des clauses de méthode. Elles sont localisées avant
