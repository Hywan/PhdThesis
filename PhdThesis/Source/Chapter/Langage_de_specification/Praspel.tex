...
Praspel est un \inenglish{Behavioral Interface Specification Language} (BISL)
...
descriptions de tableau} de la forme \code{from $K$ to $V$}, où $K$ et $V$ sont
...
ou simplement 10, et dont les valeurs sont des entiers. L'identifiant \code{a3}
et \code{a4} sont déclarés comme des tableaux hétérogène. Les deux tableaux
...
disjonctions dans les descriptions de tableaux (la construction \code{from
\ldots to \ldots}), en appliquant itérativement la règle de réécriture
suivante~:
