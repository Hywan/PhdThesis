...
pas \code{a.a.} car ici le lexème \code{.} n'est pas utilisé comme sépérateur.
...
\athrowable manquante revient à refuser tous les post-états exceptionels. Une
...
Le prédicat \apred{\code{'\$this->getUsage() + \$file->getSize()
...
normaux seront refusés car la post-condition normale sera toujours fausse. Ce
