\section{Étude cas~: approche basée sur une grammaire}
...
être produites. Dans la figure, {\scshape to} signie \inenglish{Time Out} et
...
(\inenglish{Finite State Machines}) et tend à produire une première longue donné
...
Pour tester d'avantages, nous avons modifier la grammaire en y introduisant des
