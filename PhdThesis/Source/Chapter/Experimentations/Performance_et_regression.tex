\section{Étude de cas~: performance et régression de PHP}
...
nous appelerons \code{ext/jsond}, a du être dévelopée.
...
Une fois toutes ces données générées, les auteurs de \code{ext/jsonp} on pu
