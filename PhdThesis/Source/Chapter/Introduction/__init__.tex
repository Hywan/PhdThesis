...
\subsection{Un langage de contrats pour PHP~: Praspel}
...
Ce mémoire s'articule en 7~chapitres plus annexes et bibliographie~:
%
...
\item valide nos contributions à travers une expérimentation~;
