...
à des centaines, voire des milliers, de millions de sites Web.

Internet est un réseau, composé de plusieurs couches. On a la couche
applicative. xx\% des applications constituant cette couche sont développées en
PHP.
...
directement~\acite{ArtziKDTDPE10, KiezunGJE09, McAllisterKK08, Benedikt02}. Ces
...
nouveaux \inenglish{frameworks} ou de nouvelles bibliothèques PHP ont fait leur
...
trois points, notamment le dernier, sont de réels \inenglish{challenges}
scientifiques.
...
Ce mémoire s'articule en 8~chapitres plus annexes et bibliographie, répartis
dans 4~parties~:
%
\begin{enumerate}[$\mathrm{partie}$ 1,]

\item \begin{enumerate}[$\mathrm{chapitre}$ 1,]

      \item[chapitre 1,] ce chapitre, avec l'introduction, le contexte, la
      problématique et les contributions~;
  
      \item[chapitre 2,] contient l'état de l'art nécessaire pour comprendre
...
\item \begin{enumerate}[$\mathrm{chapitre}$ 1,]
      ...
      \item[chapitre 3,] présente les domaines réalistes ainsi que Praspel, au
      niveau syntaxique et sémantique~;

      \item[chapitre 4,] présente les différents algorithmes et stratégies de
      générations de données de test~;

      \item[chapitre 5,] présente les critères de couverture pour obtenir des
...
\item \begin{enumerate}[$\mathrm{chapitre}$ 1,]
      ...
      \item[chapitre 6,] décrit les outils développés durant ce mémoire ou les
      outils incluant nos travaux~;

      \item[chapitre 7,] valide nos contributions à travers des
      expérimentations~;
...
\item \begin{enumerate}[$\mathrm{chapitre}$ 1,]
      ...
      \item[chapitre 8,] contient la conclusion et les perspectives de travaux.
