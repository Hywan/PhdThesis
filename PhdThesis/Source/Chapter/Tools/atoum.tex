...
possède aucun générateur de données, alors que Praspel en propose plusieurs. Il
a donc été encore plus naturel de rapprocher les deux projets. Cette extension,
appelée \code{atoum/praspel-extension}, est incluse dans la distribution
standard d'atoum «~sous stéroïde~», c'est~à~dire avec des outils qui ajoutent
des fonctionnalités à atoum.
