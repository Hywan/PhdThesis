...
depuis une grammaire. La variable \code{\$ast} contient l'AST produit par
...
La figure~\ref{figure:tools:om} montre les classes qui composent le modèle
objet.

\begin{sidewaysfigure}

\fig{\textwidth}{!}{Object_model.pdf}
