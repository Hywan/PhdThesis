...
\code{hoa realdom:reflection boundinteger}. Nous trouvons comme informations~:
en \circled{1} le nom de la classe qui représente l'implémentation du domaine
réaliste et son parent, en \circled{2} toutes les interfaces utilisées par cette
