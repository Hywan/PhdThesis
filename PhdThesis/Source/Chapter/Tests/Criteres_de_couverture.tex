...
réalistes de la variable \code{buffer} sont couverts. Cette suite de tests
...
\end{itemize}
%
satisfait le Critère de Couverture de Prédicat. Cette suite de tests produit les
...
de tests plus réalistes, ces critères de couverture de contrat peuvent être
