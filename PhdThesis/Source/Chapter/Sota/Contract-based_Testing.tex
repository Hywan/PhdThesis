...
Le générateur de test mélange les spécifications JML et le modèle. L'outil va
...
\paragraph{Korat} L'outil Korat~\acite{BoyapatiKM02} est la suite de Test\-Era.
...
d'écrire un prédicat en Java (appelé \code{repOK}), qui va valider ou invalider
...
résultats, mais l'expressivité qu'il offre est très faible comparé à JML.
