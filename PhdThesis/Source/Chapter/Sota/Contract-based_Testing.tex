...
JML~: un squelette où déclarer les données de tests, et les oracles, permettant
...
fournir lui-même les données de tests.
...
totallement disparu. UDITA ajoute à Java deux extensions~: des primitives de
choix non-déterministes et une primitive pour restreindre ces choix. Ces
constructions sont familières aux utilisateurs de vérificateur de modèle comme
Java PathFinder~\acite{VisserHBPL03}, sur lequel il s'appuye. UDITA est
d'ailleurs intégré au \inenglish{framework} Java PathFinder en tant
