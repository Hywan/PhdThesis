...
Les spécifications existent sous la forme de {\strong contrats}~\acite{Liskov86,
...
apparus dans le langage Eiffel~\acite{MeyerNM87}, basé sur le paradigme de la
...
exemple avec des fonctions d'ordre supérieur~\acite{FindlerF02}. Le
