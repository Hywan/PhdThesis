...
des données. Les domaines réalistes peuvent être emboîtés pour représenter des
données plus complexes. La syntaxe et la sémantique de Praspel a été définie.  À
...
pour générer des données de tests et la postcondition est utilisée comme oracle.
\\
...
employée. Cette approche a rapidement montré ses limites pour des tableaux ou
...
\section{\inlatin{Summa summarum}}
...
solveur sur les tableaux manipulant des \inenglish{Constraint Satisfaction
Problems}, et des algorithmes de \inenglish{Grammar-based Testing}. Toutes ces
